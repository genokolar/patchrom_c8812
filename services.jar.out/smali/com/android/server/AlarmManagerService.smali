...
.method private native setPowerUpalarm(IJJ)V
.end method
...
.method public setPowerUpalarm(J)V
    ...
    invoke-direct {v6}, Lcom/android/server/AlarmManagerService$Alarm;-><init>()V

    .local v6, alarm:Lcom/android/server/AlarmManagerService$Alarm;
    iput-wide p1, v6, Lcom/android/server/AlarmManagerService$Alarm;->when:J

    const-wide/16 v0, 0x0

    iput-wide v0, v6, Lcom/android/server/AlarmManagerService$Alarm;->repeatInterval:J
    ...
    iget-wide v0, v6, Lcom/android/server/AlarmManagerService$Alarm;->when:J
    ...
    .local v4, alarmNanoseconds:J
    :goto_1
    iget v1, p0, Lcom/android/server/AlarmManagerService;->mDescriptor:I

    move-object v0, p0

    invoke-direct/range {v0 .. v5}, Lcom/android/server/AlarmManagerService;->setPowerUpalarm(IJJ)V

    .end local v2           #alarmSeconds:J
    .end local v4           #alarmNanoseconds:J
    :goto_2
    monitor-exit v8
    ...
    .restart local v2       #alarmSeconds:J
    iget-wide v0, v6, Lcom/android/server/AlarmManagerService$Alarm;->when:J
    ...
    .restart local v4       #alarmNanoseconds:J
    goto :goto_1
    ...
    iget-wide v9, v6, Lcom/android/server/AlarmManagerService$Alarm;->when:J

    invoke-virtual {v0, v7, v9, v10}, Lcom/android/server/AlarmManagerService$AlarmHandler;->sendMessageAtTime(Landroid/os/Message;J)Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
