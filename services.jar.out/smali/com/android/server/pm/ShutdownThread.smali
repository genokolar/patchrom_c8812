...
# static fields
.field private static final ALARM_BEFORE_TIME:I = 0x15f90
...
.method private static beginShutdownSequence(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Landroid/util/shendu/ShenduAlarm;->getClockTime(Landroid/content/Context;)J

    move-result-wide v0

    .local v0, alarmTime:J
    const-string v5, "SFW_ALARM"
    ...
    invoke-virtual {v2, v5, v6}, Landroid/app/AlarmManager;->setPowerUpalarm(J)V

    sget-object v5, Lcom/android/server/pm/ShutdownThread;->sInstance:Lcom/android/server/pm/ShutdownThread;

    iput-object v9, v5, Lcom/android/server/pm/ShutdownThread;->mCpuWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    iput-object v9, v5, Lcom/android/server/pm/ShutdownThread;->mScreenWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    new-instance v6, Lcom/android/server/pm/ShutdownThread$6;

    invoke-direct {v6}, Lcom/android/server/pm/ShutdownThread$6;-><init>()V
...
.method static shutdownInner(Landroid/content/Context;Z)V
    ...
    invoke-direct {v5, p0, v10}, Landroid/app/AlertDialog$Builder;-><init>(Landroid/content/Context;I)V
