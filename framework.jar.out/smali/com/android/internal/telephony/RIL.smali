...
.method protected processSolicited(Landroid/os/Parcel;)V
    ...
    const-string v5, "testing emergency call, notify ECM Registrants"
...
.method protected responseDataCallList(Landroid/os/Parcel;)Ljava/lang/Object;
    ...
    .local v5, response:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/DataCallState;>;"
    const/4 v1, 0x0
    ...
    :try_start_0
    invoke-virtual {p0, p1, v7}, Lcom/android/internal/telephony/RIL;->getDataCallState(Landroid/os/Parcel;I)Lcom/android/internal/telephony/DataCallState;
    ...
    .end local v1           #i:I
    .end local v2           #num:I
    .end local v3           #num_adj:I
    .end local v5           #response:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/DataCallState;>;"
    .end local v7           #ver:I
    :cond_0
    invoke-virtual {p1}, Landroid/os/Parcel;->readInt()I
    ...
    .restart local v3       #num_adj:I
    .restart local v5       #response:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/DataCallState;>;"
    ...
    const-string v9, "getDataCallState, no ifname and/or active call without ip address"
    ...
    const-string v9, "responseDataCallList ver="
    ...
    invoke-virtual {v5, v8, v3}, Ljava/util/ArrayList;->subList(II)Ljava/util/List;
